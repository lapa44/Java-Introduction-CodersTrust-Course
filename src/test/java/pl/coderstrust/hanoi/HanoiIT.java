...
class HanoiIT {
    ...
    void shouldSolveHanoiTowersAndSaveCorrectOutputInFile(int disksNumber, List<String> expected) throws IOException {
        ...
        new HanoiFileSupport(OUTPUT_FILE_PATH).writeData(new HanoiTower(hanoiTowersList).solveHanoi(disksNumber, hanoiTowersList.get(0), hanoiTowersList.get(1), hanoiTowersList.get(2)));
